...
```text
161 passed locally
coverage: 85% total, with targeted hardening around RAG, web search, automatic factual/recipe search, model provider fallback, tool routing, API routes, and live eval entrypoints
